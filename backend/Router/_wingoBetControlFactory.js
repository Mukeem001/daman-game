...
const createWingoBetControlRouter = (BetControlModel) => {
  ...
  router.post("/getwingosresult", async (req, res) => {
    ...
    try {
      const notes = await BetControlModel.find({ priodno });
  ...
  router.post("/addwingoitems", async (req, res) => {
    try {
      const notes = new BetControlModel({
  ...
  router.put("/getwingoitems", async (req, res) => {
    try {
      ...
      const updatedNote = await BetControlModel.findOneAndUpdate(
        { priodno },
        { $inc: inc },
        { new: true }
      );
...
module.exports = createWingoBetControlRouter;
